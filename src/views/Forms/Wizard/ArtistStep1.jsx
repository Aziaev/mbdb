...
class Step1 extends React.Component {
  ...
  isValidated() {
    ...
    re.test(this.state.email) === false ? this.setState({
      emailError: (<small className="text-danger">Email is required and format should be <i>john@doe.com</i>.</small>)
  ...
  render() {
    return (
      <div className="wizard-step">
        <h5 className="text-center">Укажите данные которые нужны для регистрации</h5>
        <Row>
          <Col md={5} mdOffset={1}>
            <FormGroup>
        ...
        <Row>
          <Col md={10} mdOffset={1}>
            <FormGroup>
              ...
              <FormControl type="email" name="email" placeholder="ex: hello@creative-tim.com"
